...
if __name__=='__main__':
    ...
    if test_type == "experiment":
        ...
        path = r"../../../logs/memory_logs/m1"


    # Ensure the logs directory exists
    # Logs will be stored in the "logs/memory_logs" directory relative to the project root
    LOG_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), path, test_type))              #"../../../logs/memory_logs/m1", /app/logs, ../../../logs/memory_logs/m1/additional_testing
