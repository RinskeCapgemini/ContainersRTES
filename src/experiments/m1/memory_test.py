...
# Logs will be stored in the "logs/memory_logs" directory relative to the project root
    LOG_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../logs/memory_logs/m1/garbage_collection", test_type))              #"../../../logs/memory_logs/m1", /app/logs, ../../../logs/memory_logs/m1/additional_testing
