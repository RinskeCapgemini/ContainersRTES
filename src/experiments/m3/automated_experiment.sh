...
# Log directories
host_log_dir="/home/rinske/Github/ContainersRTES/logs/memory_logs/m3/"  # Host directory for logs
container_log_dir="/app/logs"  # Container directory for logs

# Python script directories
host_memory_test_dir="/home/rinske/Github/ContainersRTES/src/experiments/m3"  # Directory containing memory_test.py
...
for i in {0..9}; do
    ...
    sudo docker run --rm \
        ...
        -v "$host_memory_test_dir:/app/experiments/m3" \
        -v "$host_memory_calculations_dir:/app/memory_calculations" \
        general_container:1.0 /app/experiments/m3/memory_test.py $test_name $i experiment
