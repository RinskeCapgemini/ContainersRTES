...
""""
This script is designed to run memory usage experiments and log the results.
Creating two logfiles
- One for the duration of the experiment
- One for the memory usage over time.
"""
...
from memory_low import memory_low  # Function for low memory usage experiment
...
if __name__=='__main__':
    ...
    LOG_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), "/app/logs", test_type))
